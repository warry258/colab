"""
头颅 CTA 减影-whw 版 V4.5.0 (分段减影版) - 定制修改版
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[定制] 移除了 血管缩放 功能
[定制] 移除了 MIP预览 功能
...
class ProcessThread(QThread):
    ...
    def run(self):
        ...
        try:
            ...
            self.log.emit("=" * 55)
            self.log.emit(f"CTA 减影 V4.5.0 (分段减影版) | 优化:{opt_name}")
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.init_ui()
    def init_ui(self):
        self.setWindowTitle("头颅 CTA 减影-whw 版 V4.5.0 (分段减影版)")
        ...
        self.log("头颅 CTA 减影-whw 版 V4.5.0 (分段减影版)")
        self.log("=" * 50)
        self.log("V4.5.0 分段减影版说明:")
