...
def detect_problematic_bone_zones(pre_slice, z_ratio):
    ...
    skull_base = (pre_f > 250) & (pre_f < 1000) if z_ratio < 0.30 else np.zeros_like(pre_slice, dtype=bool)
...
[修复] 金属保护区 UI状态、Z轴分段映射
[核心重构] 三维立体打击逻辑（V4.5.4 终极推演大师版）：
  1. 寻核与吞噬：提取 >1700 金属核心并强行膨胀，吃掉外围梯度晕影，消灭VRT高密度外壳！
  2. 严苛验骨：局部门槛拉高至 >400，强力切断伪影连桥，宁降维勿错杀，完美保卫基底动脉！
  3. 执行死刑与印记：伪影与果皮统统降维至 40 HU 放行血管；最终输出时强制锁死 50 HU，呈现完美半透明幽灵轮廓！
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
"""
import os
import re
            ...
            for chunk_idx in range(num_chunks):
                ...
                for z in range(z_start, z_end + 1):
                    ...
                    if pre_s.max() > -500:
                        ...
                        if opt_level == 'none':
                            res = quality_subtraction_cached(pre_s_work, post_s, adj_bone, adj_vessel, cache) if opt['quality_mode'] else fast_subtraction(pre_s_work, post_s, adj_bone, adj_vessel, body=cache.body)
                        ...
                        if zone == 'skull_base':
                            ...
                            gain = enhanced_bone_suppression_v299(pre_s_work, diff_pos_work, gain, bone_zones, adj_bone)
                            res = res * gain
